...
LudoWright is in the **pre-alpha visual-foundation phase**. Product vision, long-term roadmap, layered architecture, documentation navigation, the initial Python package, project initialization, CLI workflows, tests, CI, asset planning, the v1 visual bible schema, and a provider-neutral deterministic prompt compiler are established. Executable capture profiles, visual-job planning, and ImageGen workflows remain planned.
