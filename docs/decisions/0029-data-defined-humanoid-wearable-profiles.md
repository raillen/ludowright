...
- later visual-specialty profiles can use the same data-driven boundary
  without inheriting humanoid categories; creature, hard-surface, and visual
  profiles now use that boundary in dedicated contracts.
