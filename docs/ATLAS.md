...
- [`quality/EXTERNAL_PROJECT_BETA_VALIDATION.md`](quality/EXTERNAL_PROJECT_BETA_VALIDATION.md) — opt-in validation of a small real-project asset slice, approval gating, and deterministic image preparation.
